...
DanceText:
	...
	jp TextScriptEnd
.afterBeat
	ld hl, DancePostBattleAdviceText
	call PrintText
	jp TextScriptEnd
.beforeBeat
	ld hl, DancePreBattleText
	call PrintText
...
DancePostBattleAdviceText:
	text_far _DancePostBattleAdviceText
	text_end

DanceVolcanoBadgeInfoText:
	text_far _DanceVolcanoBadgeInfoText
	text_end
