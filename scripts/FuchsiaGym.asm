...
FuchsiaGym_ScriptPointers:
	...
	dw EndTrainerBattle
	dw FuchsiaGymRedaPostBattle

FuchsiaGymRedaPostBattle:
	ld a, [wIsInBattle]
	cp $ff
...
RedaText:
	...
	jr .done
.afterBeat
	ld hl, RedaPostBattleAdviceText
	call PrintText
	jr .done
.beforeBeat
	ld hl, RedaBeforeBattleText
	call PrintText
	ld hl, wd72d
	set 6, [hl]
	set 7, [hl]
...
RedaBeforeBattleText:
	text_far _RedaBeforeBattleText
	text_end
...
RedaPostBattleAdviceText:
	text_far _RedaPostBattleAdviceText
	text_end

RedaSoulBadgeInfoText:
	text_far _RedaSoulBadgeInfoText
	text_end
