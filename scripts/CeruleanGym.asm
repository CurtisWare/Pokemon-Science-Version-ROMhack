...
CeruleanGym_ScriptPointers:
	...
	dw EndTrainerBattle
	dw CeruleanGymKoopaPostBattle

CeruleanGymKoopaPostBattle:
	ld a, [wIsInBattle]
	cp $ff
...
KoopaCascadeBadgeInfoText:
	text_far _KoopaCascadeBadgeInfoText
	text_end
