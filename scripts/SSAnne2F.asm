...
SSAnne2Text2:
	text_asm
	ld hl, SSAnneCoquiBeforeBattleText
	call PrintText
	ld hl, wd72d
	set 6, [hl]
	set 7, [hl]
	ld hl, SSAnneCoquiDefeatedText
	ld de, SSAnneCoquiWonText
	call SaveEndBattleTextPointers
	jp TextScriptEnd

SSAnneCoquiBeforeBattleText:
	text_far _SSAnneCoquiBeforeBattleText
	text_end

SSAnneCoquiDefeatedText:
	text_far _SSAnneCoquiDefeatedText
	text_end

SSAnneCoquiWonText:
	text_far _SSAnneCoquiWonText
	text_end

SSAnne2Text3:
	text_far _SSAnneCoquiCaptainText
	text_end
