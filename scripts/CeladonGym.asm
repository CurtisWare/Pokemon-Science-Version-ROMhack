...
CeladonGym_ScriptPointers:
	...
	dw EndTrainerBattle
	dw CeladonGymMeatPostBattle

CeladonGymMeatPostBattle:
	ld a, [wIsInBattle]
	cp $ff
...
MeatText:
	...
	jr .done
.afterBeat
	ld hl, MeatPostBattleAdviceText
	call PrintText
	jr .done
.beforeBeat
	ld hl, MeatPreBattleText
	call PrintText
	ld hl, wd72d
	set 6, [hl]
	set 7, [hl]
...
MeatPostBattleAdviceText:
	text_far _MeatPostBattleAdviceText
	text_end

MeatRainbowBadgeInfoText:
	text_far _MeatRainbowBadgeInfoText
	text_end
