...
SaffronGym_ScriptPointers:
	...
	dw EndTrainerBattle
	dw SaffronGymTomakeysPostBattle

SaffronGymTomakeysPostBattle:
	ld a, [wIsInBattle]
	cp $ff
...
TomakeysText:
	text_asm
	CheckEvent EVENT_BEAT_TOMAKEYS
	jr z, .beforeBeat
	...
	jr .done
.afterBeat
	ld hl, TomakeysPostBattleAdviceText
	call PrintText
	jr .done
.beforeBeat
	ld hl, TomakeysPreBattleText
	call PrintText
	ld hl, wd72d
	set 6, [hl]
	set 7, [hl]
...
TomakeysPreBattleText:
	text_far _TomakeysPreBattleText
	text_end
...
TomakeysPostBattleAdviceText:
	text_far _TomakeysPostBattleAdviceText
	text_end

RedaMarshBadgeInfoText:
	text_far _RedaMarshBadgeInfoText
	text_end
