...
ViridianGymReceiveTM27:
	...
	call DisplayTextID
	SetEvent EVENT_BEAT_VIRIDIAN_GYM_RUMMY
	lb bc, TM_FISSURE, 1
	call GiveItem
	jr nc, .BagFull
	ld a, $d
...
.gymVictory
	...
	predef ShowObject
	SetEvents EVENT_2ND_ROUTE22_COQUI_BATTLE, EVENT_ROUTE22_COQUI_WANTS_BATTLE
...
RummyText:
	text_asm
	CheckEvent EVENT_BEAT_VIRIDIAN_GYM_RUMMY
	jr z, .beforeBeat
...
.afterBeat
	...
	ld hl, RummyPostBattleAdviceText
	call PrintText
	call GBFadeOutToBlack
	ld a, HS_VIRIDIAN_GYM_RUMMY
	ld [wMissableObjectIndex], a
	predef HideObject
	call UpdateSprites
	call Delay3
...
RummyPostBattleAdviceText:
	text_far _RummyPostBattleAdviceText
	text_waitbutton
	text_end

RummyEarthBadgeInfoText:
	text_far _RummyEarthBadgeInfoText
	text_end
