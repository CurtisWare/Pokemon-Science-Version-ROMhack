...
PewterGym_ScriptPointers:
	...
	dw EndTrainerBattle
	dw PewterGymFangPostBattle

PewterGymFangPostBattle:
	ld a, [wIsInBattle]
	cp $ff
...
FangText:
	...
	jr .done
.afterBeat
	ld hl, FangPostBattleAdviceText
	call PrintText
	jr .done
.beforeBeat
	ld hl, FangPreBattleText
	call PrintText
	ld hl, wd72d
	set 6, [hl]
	set 7, [hl]
...
FangPreBattleText:
	text_far _FangPreBattleText
	text_end

FangPostBattleAdviceText:
	text_far _FangPostBattleAdviceText
	text_end
...
ReceivedBoulderBadgeText:
	...
	sound_get_item_1
	text_far _FangBoulerBadgeInfoText ; Text to tell that the flash technique can be used
	text_end
