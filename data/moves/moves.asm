...
; Characteristics of each move.
	...
	move SOIL,         NO_ADDITIONAL_EFFECT,        50, STINKY,       100, 35
	move WAO,          ATTACK_DOWN1_EFFECT,          0, STINKY,       100, 40
	move CROP_DUST,    SWIFT_EFFECT,                75, STINKY,       100, 20
	move MALD,         ATTACK_UP1_EFFECT,            0, STINKY,       100, 40
	move BAJA_BLAST,   PARALYZE_SIDE_EFFECT1,      120, STINKY,        70, 10
	move LAY_PIPE,     FLINCH_SIDE_EFFECT1,         50, HORNY,         85, 20
	move SMOKESHOW,    ACCURACY_DOWN1_EFFECT,        0, HORNY,        100, 20
	move VORE,         FLINCH_SIDE_EFFECT1,         70, HORNY,        100, 25
	move ARA_ARA,      CONFUSION_SIDE_EFFECT,       65, HORNY,        100, 20
	move RIZZED_UP,    ATTACK_UP2_EFFECT,            0, HORNY,        100, 30
	move PLAP_PLAP,    OHKO_EFFECT,                  1, HORNY,         30,  5
