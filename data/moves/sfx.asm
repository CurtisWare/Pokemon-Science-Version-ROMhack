MoveSoundTable:
	...
	db SFX_BATTLE_14,          $01, $e0 ; SOIL
	db SFX_BATTLE_0B,          $00, $40 ; WAO
	db SFX_BATTLE_1B,          $01, $a0 ; CROP_DUST
	db SFX_BATTLE_0B,          $00, $c0 ; MALD
	db SFX_BATTLE_2A,          $00, $80 ; BAJA_BLAST
	db SFX_BATTLE_32,          $00, $80 ; LAP_PIPE
	db SFX_BATTLE_1B,          $f1, $ff ; SMOKESHOW
	db SFX_BATTLE_1E,          $00, $80 ; VORE
	db SFX_BATTLE_09,          $88, $10 ; ARA_ARA
	db SFX_BATTLE_09,          $20, $c0 ; RIZZED_UP
	db SFX_BATTLE_20,          $00, $c0 ; PLAP_PLAP
