...
MapHeaderPointers::
	...
	dw SSAnne2FRooms_h
	dw SSAnneB1FRooms_h
	dw KrimbosRoom_h ; UNUSED_MAP_69
	dw KrimbosRoom_h ; UNUSED_MAP_6A
	dw KrimbosRoom_h ; UNUSED_MAP_6B
	dw VictoryRoad1F_h
	dw KrimbosRoom_h ; UNUSED_MAP_6D
	dw KrimbosRoom_h ; UNUSED_MAP_6E
	dw KrimbosRoom_h ; UNUSED_MAP_6F
	dw KrimbosRoom_h ; UNUSED_MAP_70
	dw KrimbosRoom_h
	dw KrimbosRoom_h ; UNUSED_MAP_72
	dw KrimbosRoom_h ; UNUSED_MAP_73
	dw KrimbosRoom_h ; UNUSED_MAP_74
	dw KrimbosRoom_h ; UNUSED_MAP_75
	dw HallOfFame_h
