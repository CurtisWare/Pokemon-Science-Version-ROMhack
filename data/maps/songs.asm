MapSongBanks::
	...
	db MUSIC_INDIGO_PLATEAU, BANK(Music_IndigoPlateau) ; KRIMBOS_ROOM
	...
	db MUSIC_GYM, BANK(Music_Gym) ; COLTS_ROOM
	db MUSIC_DUNGEON1, BANK(Music_Dungeon1) ; CALLIES_ROOM
	db MUSIC_POKEMON_TOWER, BANK(Music_PokemonTower) ; RAELS_ROOM
