SuperRodFishingSlots::
	...
	db CELADON_CITY, GOLDEEN, 5, GOLDEEN, 10, OMANYTE, 15, KABUTO, 20
	...
	db ROUTE_23, DRATINI, 25, POLIWAG, 30, POLIWHIRL, 30, DRATINI, 40
	...
	db CERULEAN_CAVE_1F, GOLDEEN, 25, SEAKING, 35, OMANYTE, 45, KABUTO, 55
	db CERULEAN_CAVE_B1F, GOLDEEN, 30, SEAKING, 40, KABUTO, 50, OMANYTE, 60
	db -1 ; end
