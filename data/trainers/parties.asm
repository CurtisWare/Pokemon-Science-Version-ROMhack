...
; Celadon Gym
	db 23, MEATHEAD, ICY, 0
	db 23, MACHOP, FREXEL, 0
; Viridian Forest
...
BeautyData:
; Celadon Gym
	db 21, FREXEL, FREXEL, FREXEL, MACHOKE, 0
	db 24, MACHOP, MACHOKE, 0
	db 26, ICY, 0
; Route 13
...
RummyData:
; Rocket Hideout B4F
	db $FF, 25, ONIX, 24, RHYHORN, 29, NUGGZ, 0
; Silph Co. 11F
	db $FF, 37, NIDORINO, 35, NUGGZ, 37, RHYHORN, 41, NIDOQUEEN, 0
; Viridian Gym
	db $FF, 50, DRATINI, 53, DRAGONAIR, 53, DRAGONITE, 55, NIDOKING, 55, NUGGZ, 0
...
; Jessie & James
	db 14, EKANS, KOFFING, BUD, 0
	db 25, KOFFING, EKANS, BUD, 0
	db 27, BUD, ARBOK, WEEZING, 0
	db 31, WEEZING, ARBOK, BUD, 0
; Unused
	db 16, KOFFING, 0
	db 27, KOFFING, 0
	db 29, WEEZING, 0
...
CooltrainerFData:
; Celadon Gym
	db 24, MEATHEAD, MEATHEAD, MEATHEAD, 0
; Victory Road 3F
...
CallieData:
	db $FF, 53, CHANSEY, 55, RATICATE, 55, MEOWTH, 56, PERSIAN, 0

FangData:
	db $FF, 10, GEODUDE, 12, BILLY, 0 ; ONIX

KoopaData:
	db $FF, 18, SQUIRTLE, 21, WARTORTLE, 0

LtPeonyData:
	db $FF, 26, LITTERBUG, 27, NELLIE, 28, BIRDROBOT, 0

MeatData:
	db $FF, 30, MEATHEAD, 32, MACHOKE, 32, JYNX, 0

RedaData:
	db $FF, 44, VENONAT, 46, VENONAT, 48, CANNOLI, 50, VENOMOTH, 0
...
ColtData:
	db $FF, 54, ELECTABUZZ, 53, ZAPDOS, 54, PIKACHU, 56, RAICHU, 0
...
RaelData:
	db $FF, 56, GENGAR, 55, HAUNTER, 58, ICY, 60, GENGAR, 0

KrimboData:
	db $FF, 58, HITMONCHAN, 56, HITMONLEE, 56, KREOLA, 60, GUCHA, 62, MACHAMP, 0
