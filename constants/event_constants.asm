...
; Pallet Town events
	...
	const EVENT_BATTLED_COQUI_IN_OAKS_LAB
...
; Viridian City events
	...
	const EVENT_BEAT_VIRIDIAN_GYM_RUMMY
...
; Pewter City events
	...
	const EVENT_BEAT_FANG

; Cerulean City events
	const_next $98
	const EVENT_BEAT_CERULEAN_COQUI
	const_skip 14
	...
	const EVENT_BEAT_KOOPA
	const EVENT_GOT_BICYCLE

; Lavender Town events
	const_next $F0 - 2
	const EVENT_POKEMON_TOWER_COQUI_ON_LEFT
	const EVENT_BEAT_POKEMON_TOWER_COQUI
	const_skip
...
; Route 22 events
	const_next $520
	const EVENT_1ST_ROUTE22_COQUI_BATTLE
	const EVENT_2ND_ROUTE22_COQUI_BATTLE
	const_skip 3
	const EVENT_BEAT_ROUTE22_COQUI_1ST_BATTLE
	const EVENT_BEAT_ROUTE22_COQUI_2ND_BATTLE
	const EVENT_ROUTE22_COQUI_WANTS_BATTLE
...
; Rocket Hideout events
	...
	const EVENT_BEAT_ROCKET_HIDEOUT_RUMMY
...
; Silph Co. events
	...
	const EVENT_BEAT_SILPH_CO_COQUI
	const_skip 4
	...
	const_skip
	const EVENT_BEAT_SILPH_CO_RUMMY
...
DEF INDIGO_PLATEAU_EVENTS_START EQU const_value
	const_skip
	const EVENT_BEAT_COLTS_ROOM_TRAINER_0
	const_skip 4
	const EVENT_AUTOWALKED_INTO_COLTS_ROOM
	const_skip 2
	const EVENT_BEAT_CALLIES_ROOM_TRAINER_0
	const_skip 4
	const EVENT_AUTOWALKED_INTO_CALLIES_ROOM
	const_skip 2
	const EVENT_BEAT_RAELS_ROOM_TRAINER_0
	const_skip 4
	const EVENT_AUTOWALKED_INTO_RAELS_ROOM
	const_skip 2
	const EVENT_BEAT_KRIMBOS_ROOM_TRAINER_0
	const_skip 4
	const EVENT_BEAT_KRIMBO
	const EVENT_KRIMBOS_ROOM_LOCK_DOOR
	const_skip
	const EVENT_BEAT_CHAMPION_COQUI
	const_skip 5
	const_skip
