...
NEXTU
wCoquiStarterTemp:: db
wCoquiStarterBallSpriteIndex:: db
...
wColtsRoomCurScript:: db
wCalliesRoomCurScript:: db
wRaelsRoomCurScript:: db
wCeruleanCaveB1FCurScript:: db
wVictoryRoad1FCurScript:: db
	ds 1
wKrimbosRoomCurScript:: db
	ds 4
...
; if it is set:
; 1. skips most of Prof. Oak's speech, and uses NINTEN as the player's name and SONY as the coqui's name
...
; 6. skips the NPC who blocks Route 3 before beating Fang by holding down B
; 7. skips Cerulean City coqui battle by holding down B
; 8. skips Pokémon Tower coqui battle by holding down B
...
; bit 1: set when you beat Colt and reset in Indigo Plateau lobby
